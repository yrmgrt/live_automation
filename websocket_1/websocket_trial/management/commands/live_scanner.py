...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        coord_place = coord_place + [[2,1,27,1,centre_orient,(2,0),(2,0)]]
        coord_place = coord_place + [[2,1,28+i,1,centre_orient,0,(2,0)] for i in range(3)]
        ...
        style.configure("Treeview.Heading", height=18)
        ...
        widths = []
        for i in range(4):
            widths = widths + [[40], [100, 40], [30], [30], [40, 40, 40, 40]]
        for i in range(2):
            widths = widths + [[40], [100, 40], [40], [40], [40], [30], [40], [30]]
        for i in range(2):
            widths = widths + [[40], [100, 40], [40], [40], [40], [30], [30]]
        widths = widths + [[30, 40, 40]]
        for i in range(2):
            widths = widths + [[40], [100, 40], [40], [40], [40], [30], [30]]
        widths = widths + [[40], [100, 40], [40], [40], [40], [30], [30]]
        widths = widths + [[70, 40], [30], [30], [40, 40, 40, 40]]
        ...
        while True:
            ...
            if not table_df3.empty:
                table_df3.sort_values(by=['diff_val'], ascending=True, inplace=True)
            if not table_df4.empty:
            ...
            for i, row in table_df3.iterrows():
                ...
                vals3 = (0, round(row['current_diff'],1), round(row['target'],1))
